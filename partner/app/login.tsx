      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.flex}>
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.hero}>
            <Text style={typography.h1}>{mode === "signup" ? "Join as a partner" : "Welcome back"}</Text>
            <Text style={styles.copy}>Sign in with the delivery partner account your admin set up for you.</Text>
          </View>
          ...
          >
            <Text style={styles.switchText}>
              {mode === "signup" ? "Already a partner? Sign in" : "New partner? Create an account"}
            </Text>
          </Pressable>
        </ScrollView>
