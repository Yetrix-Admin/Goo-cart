...
const U = (id, w = 800) => `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=${w}&q=70`;





export type SeedOffer = { id; restaurantId; title; description | null };

export type SeedVariant = { id; foodItemId; name; price; sortOrder };

export type SeedAddonGroup = { id; foodItemId; name; required; multiSelect; maxSelect | null };

export type SeedAddon = { id; groupId; name; price };
